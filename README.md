...
## 📚 Dataset Collections
All dataset listings have moved to a dedicated page for easier browsing and maintenance:

👉 **[View All Datasets →](DATASETS.md)**

Sections include:
- **General Open Access Datasets for Alignment** — SFT, RLHF, CoT, and instruction-tuning datasets
- **Pretraining Datasets** — Large-scale corpora for pretraining foundation models
